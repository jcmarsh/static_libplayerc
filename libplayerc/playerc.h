 ...
 * Date: 24 Aug 2001
 # CVS: $Id: playerc.h 9120 2013-01-07 00:18:52Z jpgr87 $
 **************************************************************************/
...
/** @brief Subscribe to the time device. */
...
PLAYERC_EXPORT int playerc_time_get_time(playerc_time_t *device);
...
/***************************************************************************/
/** @ingroup playerc_proxies
 * @defgroup playerc_proxy_pathplanner smart path planner

The smart path planner proxy is used to add some useful abilities to planners.

@todo write playerc_proxy_pathplanner description
...
} playerc_pathplanner_t;

PLAYERC_EXPORT playerc_pathplanner_t *playerc_pathplanner_create(playerc_client_t *client, int index);

PLAYERC_EXPORT void playerc_pathplanner_destroy(playerc_pathplanner_t *device);

PLAYERC_EXPORT int playerc_pathplanner_subscribe(playerc_pathplanner_t *device, int access);

PLAYERC_EXPORT int playerc_pathplanner_unsubscribe(playerc_pathplanner_t *device);

PLAYERC_EXPORT int playerc_pathplanner_test_one(playerc_pathplanner_t *device, int value);

PLAYERC_EXPORT int playerc_pathplanner_test_two(playerc_pathplanner_t *device, int value);
...
/***************************************************************************/
/** @ingroup playerc_proxies
 * @defgroup playerc_proxy_smrtln smart local navigator

The smart local navigator proxy is used to add some useful abilities to local navigators.

@todo write playerc_proxy_smrtln description
...
PLAYERC_EXPORT playerc_smrtln_t *playerc_smrtln_create(playerc_client_t *client, int index);

PLAYERC_EXPORT void playerc_smrtln_destroy(playerc_smrtln_t *device);

PLAYERC_EXPORT int playerc_smrtln_subscribe(playerc_smrtln_t *device, int access);

PLAYERC_EXPORT int playerc_smrtln_unsubscribe(playerc_smrtln_t *device);

PLAYERC_EXPORT int playerc_smrtln_set_param(playerc_smrtln_t *device, int index, double value);

PLAYERC_EXPORT int playerc_smrtln_sup_sensor(playerc_smrtln_t *device, int index, int state);
...
PLAYERC_EXPORT long playerc_simulation_get_time(playerc_simulation_t *device, long x);
